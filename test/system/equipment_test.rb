...
class EquipmentTest < ApplicationSystemTestCase
  ...
  test "creating a Equipment" do
    ...
    fill_in "Assigned", with: @equipment.assigned
    fill_in "Available", with: @equipment.available
    fill_in "Category", with: @equipment.category_id
    fill_in "Damaged", with: @equipment.damaged
    fill_in "Description", with: @equipment.description
    fill_in "Name", with: @equipment.name
    fill_in "Total owned", with: @equipment.total_owned
