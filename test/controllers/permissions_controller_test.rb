...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post permissions_url, params: { permission: { action: @permission.action, role_id: @permission.role_id, subject_class: @permission.subject_class, subject_id: @permission.subject_id } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { action: @permission.action, role_id: @permission.role_id, subject_class: @permission.subject_class, subject_id: @permission.subject_id } }
