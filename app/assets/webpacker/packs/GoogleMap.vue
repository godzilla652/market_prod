            ...
            <div class="select-location-wrap" v-if="supervisors">
                <select id="select-location" class="form-control custom-select custom-select-lg mb-3" @change="locationChange">
                    ...
                    <option v-for="supervisor in supervisors"
                        ...
                        :data-coordinates-updated-at="supervisor.coordinates_updated_at"
                        class="location-item">
        ...
        <div class="col-md-2 col-sm-4 col-xs-12">
            ...
            <div id="selected-content" class="supervisor-content" v-show="showDetail">
              ...
              <div class="supervisor-info">
                ...
                <div class="supervisor-info__item">
                  <div class="supervisor-info__label">Last update: </div>
                  <div class="supervisor-text">{{ selectedLocationUpdatedAt | formatDate }}</div>
                </div>
              </div>
            </div>
        </div>
...
export default {
    data(){
        return{
            ...
            showDetail: false,
            index: null,
            selectedLocationUpdatedAt: null
        }
    },
    methods:{
        mapInit(){
        ...
        locationChange(event){
            if(event.target.options.selectedIndex === 0){
                ...
                this.selectedLocationUpdatedAt = theTarget.coordinatesUpdatedAt
            }
